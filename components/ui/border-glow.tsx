...
function buildMeshGradients(colors: string[]): string[] {
  ...
  for (let i = 0; i < GRADIENT_POSITIONS.length; i++) {
    ...
    gradients.push(`radial-gradient(circle at ${GRADIENT_POSITIONS[i]}, ${colors[colorIdx]}, transparent 50%)`);
  }
  return gradients;
}
    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: 'none',
          WebkitMaskImage: `conic-gradient(from ${angleDeg}, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1) ${coneSpread}deg, rgba(0, 0, 0, 1) ${360 - coneSpread}deg, rgba(0, 0, 0, 0))`,
          maskImage: `conic-gradient(from ${angleDeg}, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1) ${coneSpread}deg, rgba(0, 0, 0, 1) ${360 - coneSpread}deg, rgba(0, 0, 0, 0))`,
        }}
      />
      ...
      <div
        style={{
          ...
          opacity: fillOpacity * borderOpacity,
          pointerEvents: 'none',
          WebkitMaskImage: `conic-gradient(from ${angleDeg}, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1) ${coneSpread}deg, rgba(0, 0, 0, 1) ${360 - coneSpread}deg, rgba(0, 0, 0, 0))`,
          maskImage: `conic-gradient(from ${angleDeg}, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1) ${coneSpread}deg, rgba(0, 0, 0, 1) ${360 - coneSpread}deg, rgba(0, 0, 0, 0))`,
        }}
      ...
      <div
        style={{
          ...
          opacity: glowOpacity,
          pointerEvents: 'none',
          boxShadow: buildBoxShadow(glowColor, glowIntensity * glowOpacity),
        }}
      />
